...
//		System.out.println();
	...
	public static void main(String[] args) {
		int[] arr = new int[] {10,12,15,13,16,19,17,18,19,10};
		HistogramPrinter printer = new HistogramPrinter();
		printer.printHistogram(arr);
		printer.printWaterFilledHistogram(arr);
		printer.printLargestRectangleFilledHistogram(arr);
