...
void filmAra(){
                ...
                switch(tercih){
                               case 1: {
                                               printf("Aranicak filmin adini giriniz : ->");
                                               scanf("%s",&aranicak);
                                               while(fread(&oscar,sizeof(oscar),1,filmDosyax))
{
                if(strcmp(aranicak,oscar.film_adi)== 0){
                               ...
                               case 2:{
                                               printf("aranicak basrolun adýný giriniz : ->");
                                               scanf("%s",&aranicak);
                                               while(fread(&oscar,sizeof(oscar),1,filmDosyax)){
                               ...
                               case 3:{
                                               printf("aranicak yonetmeni giriniz : ->");
                                                scanf("%s",&aranicak);
                                               while(fread(&oscar,sizeof(oscar),1,filmDosyax))
{
